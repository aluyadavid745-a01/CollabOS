...
const CookieConsent: React.FC = () => {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-50 px-4 pb-4 md:px-8 md:pb-6">
      <section className="mx-auto flex max-w-5xl flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-5 text-slate-950 shadow-2xl shadow-slate-900/20 md:flex-row md:items-center md:justify-between">
